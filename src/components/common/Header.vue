      ...
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item-dropdown right>
          ...
          <template slot="button-content">
            <b-img rounded="circle" width="35" height="35" src="//upload.jianshu.io/users/upload_avatars/13931029/79daa526-f4ed-424b-b494-c9a5fc202cb5.jpg?imageMogr2/auto-orient/strip|imageView2/1/w/120/h/120"/>

          </template>
          <b-dropdown-item><router-link to="/s">设置</router-link> </b-dropdown-item>
          <b-dropdown-item href="sign_in">退出</b-dropdown-item>
        </b-nav-item-dropdown>
